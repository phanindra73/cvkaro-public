...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    priceQuarterly: 799,
    priceYearly: 2499,
    description: "For students preparing for internships, placements and their first job.",
    features: [
  ...
  },
  {
    ...
    priceQuarterly: 1499,
    priceYearly: 1499,
    priceSuffixMonthly: " One-Time",
    priceSuffixQuarterly: " One-Time",
    priceSuffixYearly: " One-Time",
    description: "Get a complete career-readiness assessment and preparation plan.",
    features: [
      "Career Discovery",
      "Career Direction",
      "Career Intelligence Profile",
      ...
      "Resume Intelligence",
      "ATS Resume Analysis",
      "1 Job Description Gap Analysis",
      "Career Readiness Summary",
      "Personalized Next Steps"
    ],
    ctaText: "Get Career Ready",
    noteText: "No subscription required"
  },
  {
    id: "tier-campus",
